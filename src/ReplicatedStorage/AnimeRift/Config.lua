...
Config.Styles = {
	RiftBlade = {
		Id = "RiftBlade",
		Name = "Rift Blade",
		Description = "Balanced starter style with stable offense and defense.",
		UnlockLevel = 1,
		UnlockCost = 0,
		...
		DefenseBonus = 0,
		Color = Color3.fromRGB(151, 117, 188),
		Order = 1,
	},
	EmberKatana = {
		Id = "EmberKatana",
		Name = "Ember Katana",
		Description = "Fast and aggressive: more crit, slightly less health.",
		UnlockLevel = 4,
		UnlockCost = 1200,
		...
		DefenseBonus = 1,
		Color = Color3.fromRGB(199, 91, 53),
		Order = 2,
	},
	FrostGauntlets = {
		Id = "FrostGauntlets",
		Name = "Frost Gauntlets",
		Description = "Heavy frontline style with much higher health and defense.",
		UnlockLevel = 8,
		UnlockCost = 5200,
		...
		DefenseBonus = 16,
		Color = Color3.fromRGB(103, 164, 188),
		Order = 3,
	},
	VoidScythe = {
		Id = "VoidScythe",
		Name = "Void Scythe",
		Description = "Wide high-damage swings with modest defensive support.",
		UnlockLevel = 14,
		UnlockCost = 21000,
		...
		DefenseBonus = 6,
		Color = Color3.fromRGB(132, 91, 155),
		Order = 4,
	},
}
...
Config.Zones = {
	[1] = {
		Id = 1,
		Name = "Verdant Wilds",
		Center = Vector3.new(0, 0, 190),
		Color = Color3.fromRGB(82, 122, 78),
		UnlockLevel = 1,
		UnlockCost = 0,
	...
	[2] = {
		Id = 2,
		Name = "Ember Ravine",
		Center = Vector3.new(210, 0, 70),
		Color = Color3.fromRGB(153, 83, 55),
		UnlockLevel = 4,
		UnlockCost = 850,
	...
	[3] = {
		...
		Center = Vector3.new(80, 0, -210),
		Color = Color3.fromRGB(111, 143, 162),
		UnlockLevel = 8,
		UnlockCost = 4200,
