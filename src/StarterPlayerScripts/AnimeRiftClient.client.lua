...
local FighterAssistUI = require(AnimeRift:WaitForChild("Client"):WaitForChild("FighterAssistUI"))
...
FighterAssistUI.new(hud.Gui, fighterInventory, FighterConfig, remotes:WaitForChild("FighterAssist"))
